    ...
    <div className="rounded-2xl overflow-hidden group shadow-[0_1px_4px_oklch(0.13_0.01_260/0.07)] hover:shadow-[0_4px_16px_oklch(0.13_0.01_260/0.12)] transition-shadow duration-200">
      ...
      <Link href={detailHref}>
        <div
          ...
          style={{ backgroundColor: cardBg, height: "320px" }}
        >
          {badge && (
            <span
              className={`absolute top-3 left-3 z-10 text-[10px] font-bold tracking-widest uppercase px-2.5 py-1 rounded-full shadow-md ${badge === "Best Seller" ? "bg-[#1a3a2a] text-white" : "bg-[oklch(0.35_0.15_260)] text-white"}`}
            >
              {badge === "Best Seller" ? "★ " : ""}
              {badge}
            </span>
      ...
      <div className="bg-white px-5 pt-4 pb-5">
        ...
        <div className="flex items-baseline gap-2 mb-1">
          <h3 className="text-[1.125rem] font-bold text-[oklch(0.13_0.01_260)]">
            {name}
          </h3>
        </div>
        <p className="text-[0.6875rem] font-mono text-[oklch(0.60_0.01_260)] mb-3">
          LOT: {fixedLot ?? selected.lot}
        </p>
  ...
  return (
    <div className="rounded-2xl overflow-hidden group shadow-[0_1px_4px_oklch(0.13_0.01_260/0.07)] hover:shadow-[0_4px_16px_oklch(0.13_0.01_260/0.12)] transition-shadow duration-200">
      <Link href={detailHref}>
        <div
          className="relative overflow-hidden cursor-pointer"
          style={{ backgroundColor: p.cardBg, height: "320px" }}
        >
          {p.badge && (
      ...
      <div className="bg-white px-5 pt-4 pb-5">
        ...
        <div className="flex items-baseline gap-2 mb-1">
          ...
          <span className="text-[0.8125rem] font-semibold text-[oklch(0.52_0.01_260)]">
            {p.dose}
          </span>
        </div>
        <p className="text-[0.6875rem] font-mono text-[oklch(0.60_0.01_260)] mb-3">
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="min-h-[88vh] grid grid-cols-1 lg:grid-cols-2 overflow-x-clip">
        ...
        <div
          ref={heroRef}
          className="reveal flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-20 py-20 lg:py-0 order-2 lg:order-1"
        >
          <div className="max-w-[520px]">
            ...
            <h1 className="text-[3rem] sm:text-[3.5rem] lg:text-[4rem] font-bold leading-[1.05] tracking-tight text-[oklch(0.13_0.01_260)] mb-6">
              ...
              <br />
              <span className="text-[oklch(0.40_0.16_260)]">
                Independently tested.
              </span>
            </h1>
            <p className="text-[1.0625rem] text-[oklch(0.40_0.01_260)] leading-relaxed mb-8 max-w-[440px]">
              Vitum Lab supplies precision-synthesized peptides verified for
              purity and identity by accredited US laboratories. Every batch
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2">
              {[
                ...
                <span
                  key={t}
                  className="flex items-center gap-1.5 text-[0.8125rem] text-[oklch(0.40_0.01_260)]"
                >
        ...
        <div
          className="relative order-1 lg:order-2 flex items-center justify-center overflow-visible lg:overflow-hidden z-0"
          style={{ backgroundColor: "#f0f4f0" }}
        >
          <div
            className="relative flex items-end justify-center w-full px-6"
            style={{ marginBottom: "-5%" }}
          >
            {/* Left vial */}
            <div
              className="relative flex-shrink-0 w-[48%] z-10 vial-float-a mr-[-55px] lg:mr-[-195px]"
              style={{
            ...
            >
              <img
                src="/GHKCU%2050mg%20vial%20only.png"
            ...
            <div className="relative flex-shrink-0 w-[62%] z-20 vial-float-b">
              <img
                src="/GLP3%2020mg%20vial%20only.png"
            ...
            {/* Right vial */}
            <div
              className="relative flex-shrink-0 w-[48%] z-10 vial-float-c ml-[-55px] lg:ml-[-195px]"
              style={{
                transform: "rotate(6deg)",
                transformOrigin: "bottom center",
              }}
            >
              <img
                src="/nad%2B%20500mg%20vial%20only.png"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
            {[
              ...
              >
                ...
                <div>
                  <p className="text-[0.9375rem] font-bold mb-1 leading-snug">
                    {pillar.title}
                  </p>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="flex items-end justify-between mb-10">
            <h2 className="text-[2.25rem] font-bold tracking-tight text-[oklch(0.13_0.01_260)]">
              Featured Products
            </h2>
            <Link
              href="/shop"
              className="hidden sm:flex items-center gap-1.5 text-[0.875rem] font-semibold text-[oklch(0.40_0.16_260)] hover:underline"
            >
      ...
      <section
        ref={featuresRef}
        className="reveal py-20 bg-[oklch(0.975_0.003_260)]"
      >
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              ...
              >
                ...
                <div>
                  <h3 className="text-[1.0625rem] font-bold text-[oklch(0.13_0.01_260)] mb-2 leading-snug">
                    {f.title}
                  </h3>
                  <p className="text-[0.9rem] text-[oklch(0.40_0.01_260)] leading-relaxed">
                    {f.body}
                  </p>
                </div>
                <Link
                  href={f.href}
                  className="inline-flex items-center gap-1.5 text-[0.875rem] font-semibold text-[oklch(0.40_0.16_260)] hover:underline mt-auto"
                >
      ...
      <section
        ref={qualityRef}
        className="reveal relative py-20 bg-dark-navy text-white overflow-hidden"
      >
        ...
        <div className="container">
          <div className="flex flex-wrap gap-8 mb-12">
            <div>
              ...
              <p className="text-[0.8125rem] text-white/60 uppercase tracking-widest">
                Purity Guaranteed
              </p>
            </div>
            <div>
            ...
            <div>
              <p className="text-[2.5rem] font-bold">1,000+</p>
              <p className="text-[0.8125rem] text-white/60 uppercase tracking-widest">
                Orders Shipped
              </p>
            </div>
          ...
          <div className="lg:w-[55%]">
            ...
            <div key={activeTab} className="space-y-3">
              ...
              <div className="pt-4">
                <Link
                  href="/shop"
                  className="btn-primary bg-white text-[oklch(0.13_0.01_260)] hover:bg-white/90"
                >
                  Shop Now <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
        ...
        <div className="container max-w-3xl mx-auto">
          ...
          <p className="text-[0.9375rem] text-[oklch(0.52_0.01_260)] text-center mb-10">
            ...
            <a
              ...
              className="text-[oklch(0.40_0.16_260)] hover:underline"
            >
              Contact us
            </a>
          </p>
      ...
      <section className="py-16 bg-dark-navy text-white">
        <div className="container max-w-xl mx-auto text-center">
          <p className="text-[0.75rem] font-semibold tracking-widest uppercase text-white/50 mb-3">
            Research Updates
          </p>
...
function FaqItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border-b border-[oklch(0.91_0.004_260)]">
      ...
      >
        <span className="text-[1rem] font-semibold text-[oklch(0.13_0.01_260)] leading-snug">
          {q}
        </span>
        {open ? (
