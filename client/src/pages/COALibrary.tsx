    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-[oklch(0.93_0.004_260)]">
        <div className="container py-10">
          ...
          <p className="text-[oklch(0.52_0.01_260)] mt-2 text-[0.9375rem] max-w-xl">
            Every product is independently tested by a third-party analytical
            laboratory. Download the full Certificate of Analysis for each batch
            below.
          </p>
      ...
      <div className="container py-12">
          ...
          {coas.map(c => (
            ...
            >
              ...
              <div className={`${c.color} px-6 py-5 flex items-center gap-3`}>
                ...
                />
                <div>
                  <p className="font-bold text-[oklch(0.13_0.01_260)] text-[1rem]">
                    {c.product}
                  </p>
                ...
                <div className="ml-auto text-right">
                  <p className="text-[1.25rem] font-bold text-[oklch(0.13_0.01_260)]">
                    {c.purity}
                  </p>
                  <p className="text-[0.7rem] text-[oklch(0.50_0.01_260)]">
                    Purity
                  </p>
                </div>
              </div>
              ...
              <div className="px-6 py-5 flex-1 flex flex-col gap-3">
                <table className="w-full text-[0.8125rem]">
                  <tbody className="divide-y divide-[oklch(0.93_0.004_260)]">
                    {[
                      ...
                      <tr key={label}>
                        <td className="py-2 text-[oklch(0.52_0.01_260)] font-medium w-[45%]">
                          {label}
                        </td>
                        <td className="py-2 text-[oklch(0.20_0.01_260)] font-semibold text-right">
                          {value}
                        </td>
                      </tr>
                    ))}
                ...
                {c.purityNote && (
                  <p className="text-[0.75rem] text-[oklch(0.55_0.01_260)] italic">
                    {c.purityNote}
                  </p>
                )}
        ...
        <div className="mt-10 bg-[oklch(0.975_0.003_260)] rounded-2xl px-6 py-5 text-[0.8125rem] text-[oklch(0.50_0.01_260)] leading-relaxed max-w-3xl">
          <strong className="text-[oklch(0.30_0.01_260)]">Note:</strong> All
          COAs are issued by Constitution Laboratories LLC, an independent
          third-party analytical laboratory. Certificates relate only to the
          specific batch tested and may not be reproduced without written
          approval. All products are for in vitro / laboratory research use only
