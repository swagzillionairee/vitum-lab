...
const sections: ProductSection[] = [
  ...
  },
  {
    name: "NAD+",
    tagline:
      "A critical coenzyme in cellular energy metabolism and DNA repair pathways.",
  ...
  },
  {
    name: "GHK-Cu",
    tagline:
      "A naturally occurring copper-binding tripeptide with tissue remodeling activity.",
  ...
  return (
    <div className="bg-white rounded-2xl border border-[oklch(0.91_0.004_260)] p-6 hover:shadow-md transition-shadow">
      <div className="flex items-center gap-3 flex-wrap">
        <span
          className={`text-[0.75rem] font-semibold px-2.5 py-1 rounded-full ${badgeColor}`}
        >
          {study.journal}
        </span>
        <span className="text-[0.75rem] text-[oklch(0.65_0.01_260)]">
          {study.year}
        </span>
      </div>
        ...
        <div className="bg-[oklch(0.13_0.01_260)] text-white">
          <div className="container py-16">
            ...
            <p className="text-[1rem] text-white/70 max-w-xl leading-relaxed">
              Peer-reviewed studies and clinical literature referenced by the
              research community for compounds available at Vitum Lab.
            </p>
          </div>
        </div>
        ...
        <div className="container py-16 space-y-16">
          {sections.map(section => (
            <div key={section.name}>
              {/* Section header */}
              <div
                className={`flex items-start gap-4 mb-8 pl-5 border-l-4 ${section.borderColor}`}
              >
                <div>
          ...
          <div className="bg-[oklch(0.14_0.03_260)] text-white rounded-2xl p-8 mt-4">
            <p className="text-[0.875rem] text-white/70 leading-relaxed max-w-3xl">
              ...
              All studies linked are published third-party research. Vitum Lab
              does not claim these studies support any specific use of our
              products. All products are for in vitro / laboratory research use
              only.
            </p>
          </div>
        </div>
