      ...
      <div className="bg-white rounded-2xl border border-[oklch(0.91_0.004_260)] shadow-[0_4px_24px_oklch(0.13_0.01_260/0.08)] max-w-md w-full p-10 text-center">
        ...
        {orderId && (
          <div className="bg-[oklch(0.97_0.003_260)] rounded-xl px-5 py-4 mb-6 text-left">
            <p className="text-[0.6875rem] font-semibold tracking-widest uppercase text-[oklch(0.52_0.01_260)] mb-1">Order Reference</p>
            <div className="flex items-center justify-between gap-3">
              <span className="font-mono text-[0.875rem] font-bold text-[oklch(0.13_0.01_260)]">{orderId}</span>
              <button onClick={handleCopy} className="flex items-center gap-1 text-[0.75rem] text-[oklch(0.40_0.16_260)] font-semibold hover:underline">
