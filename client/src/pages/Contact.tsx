...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(
          data.error ||
            "Failed to send. Please email hello@vitumlab.com directly."
        );
      }
      setSubmitted(true);
    } catch (err: unknown) {
  ...
  return (
    <>
      <SEO
        title="Contact"
        description="Get in touch with the Vitum Lab team. Email us at hello@vitumlab.com for order support, research inquiries, or wholesale questions."
      />
        ...
        <div className="bg-[oklch(0.14_0.03_260)] text-white">
          <div className="container py-16">
            ...
            <p className="text-[1rem] text-white/70 max-w-lg leading-relaxed">
              Questions about an order, a product, or our quality standards?
              We're here to help.
            </p>
          </div>
        </div>
        ...
        <div className="container py-16">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3">
              <h2 className="text-[1.375rem] font-bold text-[oklch(0.13_0.01_260)] mb-6">
                Send us a message
              </h2>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <h3 className="text-[1.25rem] font-bold text-[oklch(0.13_0.01_260)] mb-2">
                    Message received!
                  </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Bulk / Institutional Order">
                  ...
                  <p className="text-[0.75rem] text-[oklch(0.65_0.01_260)]">
                    By submitting this form you confirm you are a qualified
                    researcher. All inquiries are for research purposes only.
                  </p>
            ...
            <div className="lg:col-span-2 space-y-5">
              <div className="rounded-2xl bg-[oklch(0.97_0.003_260)] p-7">
                ...
                <h3 className="text-[1rem] font-bold text-[oklch(0.13_0.01_260)] mb-1">
                  Email
                </h3>
                <p className="text-[0.875rem] text-[oklch(0.52_0.01_260)] mb-3">
                  For all inquiries, including orders, products, and
                  documentation.
                </p>
                <a
              ...
              <div className="rounded-2xl bg-[oklch(0.97_0.003_260)] p-7">
                ...
                <p className="text-[0.875rem] text-[oklch(0.52_0.01_260)]">
                  We typically respond within 1 business day. For urgent order
                  inquiries, please include your order number in the subject
                  line.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-[oklch(0.14_0.03_260)] text-white p-7">
                ...
                <h3 className="text-[1rem] font-bold mb-1">
                  Research Use Only
                </h3>
                <p className="text-[0.875rem] text-white/70 leading-relaxed">
                  All products are sold strictly for in vitro / laboratory
                  research use only. By contacting us you confirm you are a
