    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-page">
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-[0_2px_16px_oklch(0.13_0.01_260/0.1)] p-8">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 w-full py-3 rounded-full border-2 border-[oklch(0.88_0.004_260)] text-[oklch(0.20_0.01_260)] font-semibold text-[0.875rem] hover:bg-[oklch(0.98_0.002_260)] transition-colors"
        >
        ...
        <div className="mt-6 pt-5 border-t border-[oklch(0.93_0.004_260)] text-center">
          ...
          <Link
            ...
            className="inline-block w-full py-2.5 rounded-full border border-[oklch(0.88_0.004_260)] text-[0.8125rem] font-semibold text-[oklch(0.35_0.15_260)] hover:bg-[oklch(0.98_0.002_260)] transition-colors"
          >
            Affiliate Login
          </Link>
        </div>
