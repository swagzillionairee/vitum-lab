...
export default function About() {
  return (
    <>
      <SEO
        title="About"
        description="Learn about Vitum Lab's mission to supply research-grade peptides with verified purity, transparent COAs, and fast 2–3 day US shipping."
      />
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-[oklch(0.14_0.03_260)] text-white">
          <div className="container py-20">
            ...
            <p className="text-[1.0625rem] text-white/70 max-w-xl leading-relaxed">
              Vitum Lab was founded with a single premise: researchers deserve
              access to compounds that are exactly what they claim to be, backed
              by documentation they can independently verify.
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-[oklch(0.91_0.004_260)]">
              {stats.map(s => (
                <div key={s.value} className="px-8 py-8">
                  <p className="text-[2.25rem] font-bold text-[oklch(0.13_0.01_260)] leading-none mb-1">
                    {s.value}
                  </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="space-y-4 text-[0.9375rem] text-[oklch(0.40_0.01_260)] leading-relaxed">
                <p>
                  The research peptide market has historically suffered from
                  inconsistent quality, opaque sourcing, and a lack of
                  accountability. Vitum Lab was established to address this
                  directly — by building a supply chain grounded in
                  documentation, independent testing, and full transparency.
                </p>
                <p>
                  We supply exclusively to qualified researchers and
                  institutions for in vitro and laboratory research
                  applications. Every product in our catalog is lyophilized for
                  stability, independently verified for purity and identity, and
                  accompanied by a Certificate of Analysis from an accredited US
                  laboratory.
                </p>
                <p>
                  Our commitment is simple: if we cannot provide documentation
                  for it, we do not sell it.
                </p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="rounded-2xl bg-[oklch(0.97_0.003_260)] p-8">
                <p className="text-[0.75rem] font-semibold tracking-widest uppercase text-[oklch(0.52_0.01_260)] mb-3">
                  Research Use Only
                </p>
                <p className="text-[0.9375rem] text-[oklch(0.40_0.01_260)] leading-relaxed">
                  All products sold by Vitum Lab are strictly for in vitro /
                  laboratory research use only. They are not intended for human
                  or veterinary use, and are not for use in diagnostic
                  procedures. By purchasing, customers confirm they are
                  qualified researchers.
                </p>
                <Link
                  href="/research-disclaimer"
                  className="inline-flex items-center gap-1.5 text-[0.875rem] font-semibold text-[oklch(0.40_0.16_260)] hover:underline mt-4"
                >
              ...
              <div className="rounded-2xl bg-[oklch(0.14_0.03_260)] text-white p-8">
                ...
                <p className="text-[0.9375rem] text-white/75 leading-relaxed">
                  Every batch Certificate of Analysis is publicly accessible.
                  Search by product, lot number, or test date.
                </p>
                <Link
                  href="/coa-library"
                  className="inline-flex items-center gap-1.5 text-[0.875rem] font-semibold text-white hover:underline mt-4"
                >
        ...
        <div className="bg-[oklch(0.97_0.003_260)] py-20">
          <div className="container">
            <p className="text-[0.75rem] font-semibold tracking-widest uppercase text-[oklch(0.52_0.01_260)] mb-4 text-center">
              How We Operate
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {values.map(v => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-[1.0625rem] font-bold text-[oklch(0.13_0.01_260)] mb-2">
                      {v.title}
                    </h3>
        ...
        <div className="container py-20 text-center">
          <h2 className="text-[2rem] font-bold text-[oklch(0.13_0.01_260)] mb-4">
            Ready to start your research?
          </h2>
          <p className="text-[0.9375rem] text-[oklch(0.52_0.01_260)] mb-8 max-w-md mx-auto">
            Browse our full catalog of independently verified research peptides
            with COAs included.
          </p>
